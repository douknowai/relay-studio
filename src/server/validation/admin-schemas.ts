...
export const adminUpdateUserSchema = z
  .object({
    ...
    daily_video_limit: z.number().int().min(0).optional(),
    monthly_video_limit: z.number().int().min(0).optional(),
    max_concurrent_tasks: z.number().int().min(1).optional(),
    max_images_per_request: z.number().int().min(1).optional(),
    max_videos_per_request: z.number().int().min(1).optional(),
...
export const adminCreateModelSchema = z
  .object({
    ...
    supports_text_to_video: z.boolean().optional(),
